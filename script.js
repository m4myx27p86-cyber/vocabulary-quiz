...
function checkDatePassword() {
  ...
  if (input === getTodayPassword()) {
    ...
    document.getElementById("loginMessage").textContent = "今日の日付4桁と一致しません。例：5月15日 → 0515";
  }
}
...
function showOnly(id) {
  [
    "loginScreen", "studentScreen", "menuScreen", "materialPasswordScreen", "calendarScreen",
